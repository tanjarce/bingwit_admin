...
export default class CBReactTablePagination extends Component {
  ...
  Next () {
    ...
    this.setState((prevState)=>({
      currentPage: currentPageonProps + 1
    }), ()=>{
      // const { paginationData: {offset, limit}, updateTable, pageSize } = this.props
  ...
  render () {
    const {paginationData: {offset, limit}, showPageSizeOptions, pageSizeOptions, onPageSizeChange, dataCount } = this.props
            ...
            {this.props.pageText}{''}
              {
                <CustomInput
                  ...
                  type='number'
                  value={
                    focus? currentPage || '' : currentPageonProps 
                  }
